...
for func in ['mgga_x_lak', 'mgga_c_lak']:
    ...
    feval = pylibxc.LibXCFunctional(func, "polarized")
...
#    bad_funcs = ['mgga_x_edmgga', 'hyb_mgga_xc_edmggah']
    ...
    for a in list(data.ke_test.keys()):
        ...
        nE, vrho, vsigma, vtau, vlapl = atom.libxc_eval(r, functional=func, restricted=False, density_threshold=dens_thresh, sigma_threshold=sigma_thresh, nan_check=True)
